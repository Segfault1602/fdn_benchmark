...
class FDN
{
  public:
    ...
    int getMinDelayLength()
    {
        return minDelayLength;
    };
    int getMaxDelayLength()
    {
  ...
  private:
    ...
    // Center frequencies
    std::vector<double> fc2 = {31.25, 44.2,   62.5, 88.39,  125,  176.78, 250,  353.55,  500,  707.11,
                               1000,  1414.2, 2000, 2828.4, 4000, 5656.9, 8000, 11313.7, 16000};
